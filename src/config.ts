...
export const COOKIE_LIVETIME_IN_DAYS = 14;
export const FINGERPRINT_COOKIE_NAME = '_s';
...
export const MONGO_PORT = process.env.MONGO_PORT || 4321;
export const MONGO_LOGIN = process.env.MONGO_INITDB_ROOT_USERNAME || '';
export const MONGO_PASS = process.env.MONGO_INITDB_ROOT_PASSWORD || '';
export const MONGO_DB = process.env.MONGO_INITDB_DATABASE || '';
